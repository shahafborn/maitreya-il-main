/**
 * Heart of Wisdom Retreat — DRAFT (Hebrew)
 * ========================================
 *
 * Local-only draft copy of HeartOfWisdomRetreat.tsx for iteration.
 * Route: /events/heart-of-wisdom-retreat-draft (dev only, not linked from nav).
 * Once a winning version is chosen, copy changes into HeartOfWisdomRetreat.tsx
 * and delete this file + its route in App.tsx.
 *
...
const HeartOfWisdomRetreatDraft = () => {
  ...
  return (
    ...
    >
      ...
      <ScheduleBlock
        ...
        intro="ריטריט עירוני, ללא לינה. המשתתפים מגיעים בבוקר וחוזרים לביתם בערב. כל יום יכלול לימוד, תרגול מודרך, והדרכה מעשית, עם הפסקת צהריים ארוכה והפסקות קצרות במהלך השיעורים. חניכת מנג׳ושרי הלבן תתקיים במהלך הריטריט."
        days={scheduleDays}
        notes={[
...
export default HeartOfWisdomRetreatDraft;
