...
const WEEK_OVERRIDES: WeekOverride[] = [
  ...
  },
  {
    ...
    from: "2026-09-13",
    to: "2026-10-18",
    // (banner removed 2026-09-23, Shahaf: not needed - the timetable shows it) was: "בימי ראשון, מ-13.9 עד 18.10, מתקיימת ב-16:00 סדרת המפגשים \"מוות, לחיות לנוכח המוות, והארה\" עם לאמה גלן, ותרגול טארה הירוקה עובר ל-20:30.",
    days: {
      "ראשון": {
        afternoon: [
          {
  ...
  },
  {
    ...
    from: "2026-09-17",
    to: "2026-10-22",
    // (banner removed 2026-09-23, Shahaf: not needed - the timetable shows it) was: "בימי חמישי, מ-17.9 עד 22.10, מתקיים ב-15:00 מפגש הבהרות ותרגול מודרך עם דרופון צ׳ונגוואל-לה לנרשמי הסדרה \"מוות, לחיות לנוכח המוות, והארה\", בחדר זום אחר. בשבועות אלה תרגול הטומו (נארופה) עובר ל-17:00.",
    days: {
      "חמישי": {
        afternoon: [
          {
