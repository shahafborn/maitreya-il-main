  ...
  return (
    ...
    >
      ...
      <SectionFrame tone="cream" maxWidth="md" size="md">
        ...
        >
          המסורת הבודהיסטית הטיבטית מציעה דרך ישירה להכיר את טבע התודעה שלנו - בהיר, פתוח וער. בסדרה זו נלמד עם לאמה גלן מולין את מסורת המהמודרה, ונתרגל את כוחם של ההקשבה, ההתבוננות והמדיטציה, שמאפשרים לנו לחוות את האיזון המושלם שבין הריקות ובין השמחה של עצם ההוויה.
        </p>
