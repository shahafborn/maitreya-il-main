        ...
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <div className="space-y-6 text-lg text-foreground/80 leading-relaxed">
            <p>
              ...
              והארה. בריטריט מיוחד זה נלמד עם לאמה גלן מולין, תלמידו האישי
              של הדלאי לאמה, מהו ריפוי לפי הבודהיזם הטנטרי ונתרגל שלושה
              מתרגולי הליבה של הריפוי הטנטרי - תרגולים עתיקים ורבי עוצמה
              לריפוי, לאיזון, להארכת חיים ולהעמקה בדרך הרוחנית.
            </p>
          </div>
        </div>
      </section>
            ...
            {[
              {
                ...
                description:
                  "הגלגל מגשים המשאלות, היא בודהה נשית המגלמת את חמש הפעילויות המוארות של התודעה הערה: השקטה, משיכה (זימון), העשרה, פעולה עוצמתית והגנה. תרגולה עוצמתי במיוחד להארכת חיים, לריפוי, ולהסרת מכשולים פנימיים וחיצוניים.",
              },
              {
                title: "מדיסין בודהא",
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <div className="space-y-6 text-lg text-foreground/80 leading-relaxed mb-8">
            <p>
              מתחם שקט ויפה הפונה לים המלח עם נוף ישיר לים ולהרי מואב. חמש
              דקות נסיעה מקיבוץ עין גדי, קרוב לשמורת הטבע ולמצוקי דרגות.
            </p>
            <p>
