...
// Reused Ein Gedi n8n webhook; n8n routes on `field_event` / `source`.
...
const seo: SEOConfig = {
  title: "ריטריט מהמודרה: לב החוכמה | 28-30 במאי 2026 | מאיטרייה סנגהה ישראל",
  description:
    "ריטריט עירוני של שלושה ימי לימוד ותרגול של שיטות החוכמה הייחודיות של הבודהיזם הטנטרי עם לאמה גלן מולין, כולל חניכה למנג׳ושרי הלבן. תל אביב, 28-30 במאי 2026.",
  keywords:
...
const registrationCopy = {
  ...
  submitFootnote: "לאחר מילוי הטופס תועברו לדף תשלום מאובטח. תוכלו לבחור סכום קבוע או סכום פתוח.",
...
const scheduleDays = [
  { label: "יום חמישי, 28 במאי 2026", time: "09:30-18:00" },
  { label: "יום שישי, 29 במאי 2026", time: "09:30-18:00" },
  { label: "יום שבת, 30 במאי 2026", time: "09:30-16:00" },
];
  ...
  return (
    ...
    >
      <RetreatHero
        ...
        subtitle="שלושה ימי לימוד ותרגול של שיטות החוכמה הייחודיות של הבודהיזם הטנטרי, בליווי חניכה למנג׳ושרי הלבן"
      ...
      <AboutSection
        ...
        paragraphs={[
          ...
          <>
            בריטריט זה ילמד לאמה גלן את שיטות החוכמה הייחודיות של הבודהיזם הטנטרי, על בסיס השיר מהמאה ה-18 של הדלאי לאמה ה-7 - <strong>״כניסה לריקות מכל ארבעת הכיוונים״</strong>. שיר עומק שהוא בה בעת מפת דרכים מעשית לתרגול מהמודרה - המבט הישיר בטבע התודעה.
          </>,
      ...
      <ScheduleBlock
        ...
        intro="ריטריט עירוני, ללא לינה. המשתתפים מגיעים בבוקר וחוזרים לביתם בערב. כל יום יכלול לימוד, תרגול מודרך, והדרכה מעשית. חניכת מנג׳ושרי הלבן תתקיים במהלך הריטריט."
        days={scheduleDays}
        notes={[
      ...
      <WhatsIncluded bgImage={venuePhoto1} eyebrow="מה כולל הריטריט" items={whatsIncluded} />

      <div ref={ctaSectionRef}>
        <DanaSection
          title="השתתפות בדאנא"
          paragraphs={[
            "🪷 ההשתתפות בלימוד היא בדאנא מראש - תרומה מתוך נדיבות הלב.",
      ...
      <FinalCTA
        ...
        body="שלושה ימי עומק של לימוד ותרגול שיטות החוכמה של הבודהיזם הטנטרי, עם חניכה למנג׳ושרי הלבן, בלב תל אביב"
        ctaLabel="להרשמה לריטריט"
        onCtaClick={open}
