    ...
    >
      ...
      <AboutSection
        ...
        paragraphs={[
          ...
          "בבודהיזם הטיבטי נלמדות עד היום מסורות רבות של התרגולים היוגיים האלה, הידועים כעבודה עם הקונדליני - צ׳אנדלי בסנסקריט, טומו בטיבטית. בתרגולים האלה לומדים לעבוד ישירות עם האנרגיות של הגוף (הפראנה, או הצ׳י) ועם התמציות שלו (הבינדו, או האוג׳ה): לאזן ולטהר את מערכת העצבים ואת המערכת ההורמונלית, לשחרר דפוסים שאינם מיטיבים, ולהגיע למצבי תודעה עמוקים ומרפאים.",
      ...
      <SectionFrame tone="cream" maxWidth="xl">
        ...
        <figure className="max-w-[360px] mx-auto mb-12 md:mb-16">
          <img
            ...
            alt="מערכת הצ׳אקרות והערוץ המרכזי"
          ...
          >
            מערכת הצ׳אקרות והערוץ המרכזי - הגוף העדין שעליו נעשית עבודת הקונדליני (צ׳אנדאלי או טומו)
          </figcaption>
        </figure>
      ...
      <SectionFrame tone="stone" size="md" maxWidth="lg">
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <p>המנטרה של פאלדן להמו, הידועה כ״שבעת הג׳ו״, רבת עוצמה במיוחד להשגת בריאות, שפע ואושר, תוך התקדמות בדרך אל ההארה.</p>
