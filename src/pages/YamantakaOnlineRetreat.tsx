...
const registrationConfig: RegistrationConfig = {
  ...
  tiers: [
    ...
    },
    {
      ...
      title: "שלושת החודשים - תשלום אחד",
      priceDisplay: "750",
      priceValue: 750,
      currencySymbol: "₪",
    },
    {
      id: "Yamantaka_Online_Full_2",
      title: "שלושת החודשים - 2 תשלומים",
      note: "375 ש״ח בכל חיוב",
      priceDisplay: "750",
      priceValue: 750,
      currencySymbol: "₪",
    },
    {
      ...
      title: "שלושת החודשים - 3 תשלומים",
      note: "250 ש״ח בכל חיוב",
      priceDisplay: "750",
      priceValue: 750,
      currencySymbol: "₪",
    },
...
const registrationCopy = {
  ...
  paymentNote: "התשלום מתבצע מול קארדקום. אפשר לשלם בכרטיס אשראי או בביט. הקבלה תישלח לאימייל שמילאתם.",
};
...
const scheduleNotes = [
  ...
  "למי ששוהים במקום: בין המפגשים ארוחת צהריים והליכה, תרגול צ׳ולן (Chulen), קריאה והליכה. תהיה אפשרות לקיים שלושה או ארבעה מפגשי תרגול ביום.",
];
  ...
  return (
    ...
    >
      <RetreatHero
        ...
        subtitle="ריטריט מלא בן שלושה חודשים"
        accent="עם דרופון צ׳ונגוואל-לה"
        dateLine="1 בספטמבר עד 20 בנובמבר 2026 | בימים שני עד שישי | מפגשים מקוונים"
      />
      ...
      <AboutSection
        ...
        paragraphs={[
          ...
          "בכל יום מתקיימים מפגשי תרגול ולימוד, בימים שני עד שישי. אפשר להצטרף לריטריט המלא, או להשתתף בלימוד בלבד.",
        ]}
      ...
      <SectionFrame tone="cream" maxWidth="md">
        <SectionTitle className="text-center mb-8">למשתתפים בריטריט המלא</SectionTitle>
        ...
        <p
          className="max-w-2xl mx-auto mt-8 text-base leading-[1.9]"
          style={{ color: RETREAT_THEME.WARM_GRAY }}
        >
          למי שמעוניינים להשתתף רק בלימוד: בכל שבוע תתקיים תוכנית שונה, ולוח התוכנית הסופי ייקבע לאחר ההרשמה.
        </p>
      </SectionFrame>
      ...
      <DanaSection
        ...
        paragraphs={[
          ...
          "אפשר לתת דאנה חודשית, ואז לקראת כל חודש נשלח קישור חדש, או לתת מראש עבור שלושת החודשים - בתשלום אחד, בשניים או בשלושה.",
        ]}
        suggestedLine="300 ש״ח לחודש · או 750 ש״ח לשלושת החודשים"
        footerNote="התשלום אינו ניתן להחזר."
