          ...
          <>
            ...
            <DialogHeader className="text-center sm:text-center">
              ...
              <DialogDescription className="text-base mt-3 leading-relaxed" style={{ color: WARM_GRAY }}>
                תודה שנרשמתם לריטריט "שש היוגות של ניגומה".
                <br />
...
const SixYogasNigumaRetreat = () => {
  ...
  useRetreatSEO({
    title: "שש היוגות של ניגומה: ריטריט עם לאמה גלן בעין גדי | 6-12 בדצמבר 2026 | מאיטרייה סנגהה ישראל",
    description: eventJsonLd.description,
    keywords: "שש היוגות של ניגומה, ניגומה, טומו, ואג׳ראיוגיני, ריטריט, עין גדי, ים המלח, חנוכה, לאמה גלן, בודהיזם טיבטי, טנטרה, מאיטרייה סנגהה",
    url: eventJsonLd.url,
    ...
    <div dir="rtl" style={{ backgroundColor: CREAM, color: DARK, fontFamily: "'Open Sans', 'Heebo', sans-serif" }} className="min-h-screen">
      ...
      <div className="py-12 md:py-16" style={{ backgroundColor: CREAM }}>
        <div className="max-w-3xl mx-auto px-6">
          <p className="text-lg md:text-xl leading-[1.8] text-center mb-6" style={{ color: "#3D3830" }}>
            מסורת התרגול הבודהיסטית של שש היוגות של ניגומה, שמקורן במיסטיקנית ההודית ניגומה בת המאה ה-10, היא אחת המערכות היעילות ורבות העוצמה שבמסורת הוואג׳ריאנה (הבודהיזם הטנטרי). שש היוגות מאפשרות לנו להשתמש בגוף, באנרגיה ובתודעה בדרכים יוצאות דופן, שמייצרות מצבים עמוקים של טיהור, הבנה ואושר - ובסופו של דבר מביאות אותנו להארה מלאה.
          </p>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6">
          <div className="bg-white/85 backdrop-blur-md rounded-lg p-10 md:p-16 shadow-xl max-w-3xl mx-auto">
            ...
            <div className="space-y-6 text-lg leading-[1.8]" style={{ color: "#3D3830" }}>
              ...
              <p>
                שש היוגות של ניגומה הן מהתרגולים החשובים ביותר של יוגים ומתרגלים במסורות הבודהיזם הטנטרי של אסיה, והן מתורגלות ברציפות כבר מעל אלף שנה - כולל בשושלת הדלאי לאמות של טיבט. רק בשנים האחרונות החלו ללמד אותן במערב. זוהי הזדמנות מיוחדת ללמוד את המערכת רבת העוצמה הזאת לטרנספורמציה פנימית, ישירות מלב השושלת.
              </p>
              <p>
                בריטריט ילמד לאמה גלן מולין, תלמידו האישי של הדאלאי לאמה ומורה בינ״ל לבודהיזם טיבטי, את שש היוגות שלב אחר שלב - לימוד, הדרכה מעשית ותרגול מודרך.
              </p>
              <p>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-3xl mx-auto px-6">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-4" style={{ fontFamily: "'Playfair Display', 'Frank Ruhl Libre', serif" }}>
            מהן שש היוגות של ניגומה?
          </h2>
          <p className="text-lg text-center mb-12" style={{ color: WARM_GRAY }}>
            המיסטיקאית בת המאה ה-10 לימדה את המערכת הטנטרית של שש היוגות - מפת הדרכים של הטכניקות הפנימיות להגעה מהירה להארה. שש היוגות הן:
          </p>
          ...
          <p className="text-lg leading-[1.8] max-w-2xl mx-auto mt-12" style={{ color: "#3D3830" }}>
            שש היוגות מאפשרות לנו להתמיר את כל מצבי החיים - ערות ושינה, מדיטציה וחיי היום יום, חיי האהבה ואפילו את תהליך המוות - לתוך הדרך להתעוררות רוחנית.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-[auto_1fr] gap-8 md:gap-12 items-center">
            ...
            <div>
              ...
              <div className="space-y-5 text-lg leading-[1.8]" style={{ color: "#3D3830" }}>
                <p>את שש היוגות של ניגומה נלמד בהקשר של התרגול הטנטרי של ואג׳ראיוגיני - המאפשר לנו להשתמש באש התשוקה וההיקשרות ולהתמיר אותה לחוכמה עילאית. תרגול ואג׳ראיוגיני ידוע כתרגול מהיר ועוצמתי במיוחד, והוא תרגול עיקרי בכל הזרמים של הבודהיזם הטיבטי - כולל בשושלת הדלאי לאמות.</p>
          ...
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center mb-20">
            <div>
              ...
              <div className="space-y-4 text-lg leading-[1.8]" style={{ color: "#3D3830" }}>
                <p>הריטריט מתחיל ביום ראשון, 6 בדצמבר, בשעה 12:00, ומסתיים ביום שבת, 12 בדצמבר 2026, בשעה 15:00.</p>
          ...
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center mb-20">
            ...
            <div className="order-1 md:order-2">
              ...
              <div className="space-y-6">
                {[
                  { days: "יום ראשון, 6 בדצמבר", practice: "הגעה, התמקמות ותחילת לימוד שש היוגות", times: "הגעה: 12:00 | אחה״צ: 14:30-18:15" },
                  { days: "שני עד שישי, 7-11 בדצמבר", practice: "שש היוגות של ניגומה", times: "בוקר: 9:30-12:30 | אחה״צ: 14:30-18:15" },
      ...
      <section className="py-12 border-t border-stone-200">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-lg mb-5" style={{ color: WARM_GRAY }}>
